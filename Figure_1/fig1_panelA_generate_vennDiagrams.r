...
shared_hyperDMRs = read.table("/tavern/jflynn/Projects/cancer_enhancer_project/data/6_DMR_groups/6_groups_each_row_different_DMR_sorted_all_DMRs_with_CpGs/shared_EAC_GBM_hyperDMRs_one_line_one_DMR_sorted.bed")
...
# HypoDMRs
eac_hypoDMRs = read.table("/tavern/jflynn/Projects/cancer_enhancer_project/data/6_DMR_groups/4_groups_each_row_different_DMR_sorted_all_DMRs_with_CpGs/EAC_hypoDMRs.bed")
gbm_hypoDMRs = read.table("/tavern/jflynn/Projects/cancer_enhancer_project/data/6_DMR_groups/4_groups_each_row_different_DMR_sorted_all_DMRs_with_CpGs/GBM_hypoDMRs.bed")
shared_hypoDMRs = read.table("/tavern/jflynn/Projects/cancer_enhancer_project/data/6_DMR_groups/6_groups_each_row_different_DMR_sorted_all_DMRs_with_CpGs/shared_EAC_GBM_hypoDMRs_one_line_one_DMR_sorted.bed")
